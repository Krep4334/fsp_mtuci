...
**Краткая инструкция по запуску (Mac / Windows / Docker, MinIO):** [docs/ЗАПУСК.md](docs/ЗАПУСК.md)  
**Вопросы преподавателю и ответы (защита):** [docs/ВОПРОСЫ_ПРЕПОДУ.md](docs/ВОПРОСЫ_ПРЕПОДУ.md) ([указатель в корне](ВОПРОСЫ_ПРЕПОДУ.md))
